...
Created a **water rocket simulation script** in **MATLAB** using iterative equations, automatically scaling **timestep-dependent arrays**. The model simulated the entire rocket path, subdivided into **thrust phase**, **deceleration phase**, and **parachute phase**.
